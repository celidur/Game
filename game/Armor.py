class Armor:
    ...
    def get_stat(self):
        return self.defense_base, self.defense_plain, self.defense_desert, self.defense_snow, self.defense_forest, \
               self.defense_mountain, self.defense_volcano
...
class Sword:
    ...
    def get_stat(self):
        return self.attack_base, self.attack_plain, self.attack_desert, self.attack_snow, self.attack_forest, \
               self.attack_mountain, self.attack_volcano
